    ...
    <>
      <div className="m-auto bg-gray-100 h-screen flex flex-col">
        <div className="m-auto w-3/4 md:h-1/4 md:w-1/4 flex flex-col gap-4">
          ...
          <input className=" border rounded-md px-4 py-3 border-gray-300 mb-5 md:text-lg" placeholder="password" name="password" type="password" onChange={handleChange}></input>
